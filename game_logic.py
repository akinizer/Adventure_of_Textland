...
def apply_character_choices_and_stats(player_obj, species_id, class_id, char_name, char_gender,
    ...
    player_obj.max_hp = class_stats["hp"] + species_bonuses.get("hp_bonus", 0)
    player_obj.hp = player_obj.max_hp
    player_obj.attack_power = class_stats["attack_power"] + species_bonuses.get("attack_bonus", 0)
